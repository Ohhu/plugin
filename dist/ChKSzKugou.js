...
const $9220485a37509564$export$94bbe8f22941309c = 12e3;

const $9220485a37509564$export$1ad3691e597a27ef = 25e3;

const $9220485a37509564$var$CHKSZ_MAX_RETRY_AFTER_SECONDS = 10;

const $9220485a37509564$var$API_KEY_VARIABLE_NAMES = [ "apikey", "apiKey", "key", "API Key" ];
...
async function $9220485a37509564$export$ad90614321195e52(options) {
    ...
    const requestOnce = async function() {
        try {
            return await (0, $parcel$interopDefault($7JVaH$axios)).get(url, {
                timeout: timeoutMs,
                responseType: "json",
                validateStatus: () => true
            });
    ...
    if (response && response.status === 429) {
        ...
        if (retryAfter !== null && retryAfter <= $9220485a37509564$var$CHKSZ_MAX_RETRY_AFTER_SECONDS) {
            await $9220485a37509564$var$sleep((retryAfter + 1) * 1e3);
...
function $0c106dafb4e2ddcd$export$c4ed8c822f31cc12(a, b, c, d, e, f, g, h) {
    return $0c106dafb4e2ddcd$var$pickDefined([ a, b, c, d, e, f, g, h ]);
}
...
const $0c106dafb4e2ddcd$var$URL_LIKE_KEYS = [ "url", "musicUrl", "playUrl", "play_url", "link" ];
...
const $0c106dafb4e2ddcd$var$PREFERRED_LIST_KEYS = [ "songs", "list", "tracks", "musicList", "songlist" ];
...
function $0c106dafb4e2ddcd$var$looksLikeSongs(items) {
    ...
    for (let i = 0; i < sampleCount; i += 1) {
        ...
        const hasIdentity = $0c106dafb4e2ddcd$var$pickDefined([ record.id, record.songId, record.song_id, record.mid, record.songmid, record.musicId, record.hash ]);
...
function $0711457daf45bbf8$var$createPointSongPlugin(options) {
    ...
    async function fetchDetail(self, musicItem, size) {
        ...
        const keyword = (0, $0c106dafb4e2ddcd$export$8d3f56d05539298a)(record.keyword, `${(0, 
        $0c106dafb4e2ddcd$export$8d3f56d05539298a)(record.title) || ""} ${(0, $0c106dafb4e2ddcd$export$8d3f56d05539298a)(record.artist) || ""}`.trim());
        ...
        const data = await (0, $9220485a37509564$export$ad90614321195e52)({
            ...
            params: params,
            self: self,
            timeoutMs: (0, $9220485a37509564$export$1ad3691e597a27ef)
        });
...
const $0711457daf45bbf8$export$7a13aa922dabd899 = "ChKSz·QQ音乐";

function $0711457daf45bbf8$export$2ef6d92eb854799e() {
    return $0711457daf45bbf8$var$createPointSongPlugin({
        platform: $0711457daf45bbf8$export$7a13aa922dabd899,
...
module.exports = (0, $0711457daf45bbf8$export$eaa44ae5e5e89012)();